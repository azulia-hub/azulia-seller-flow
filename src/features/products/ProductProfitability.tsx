...
export function ProductProfitability({ items, portfolio, formatMoney, fileName, onManageCosts, onSelectSku }: Props) {
  ...
  return <>
    ...
    <section className="product-kpis"><article className="positive"><span>Portfolio profit</span><strong>{formatMoney(portfolio.portfolioProfit)}</strong><small>Includes {formatMoney(portfolio.unassignedOperating)} unassigned operating activity</small></article><article className="accent"><span>Gross sales</span><strong>{formatMoney(portfolio.grossSales)}</strong><small>{portfolio.skuCount} selling SKUs</small></article><article className="positive"><span>Profitable SKUs</span><strong>{portfolio.profitableSkuCount}</strong><small>With complete cost data</small></article><article className="negative"><span>Loss-making SKUs</span><strong>{portfolio.lossMakingSkuCount}</strong><small>With complete cost data</small></article><article className="warning"><span>Missing costs</span><strong>{portfolio.missingCostSkuCount}</strong><small>Profit remains estimated</small></article><article className="neutral"><span>Net COGS</span><strong>{formatMoney(portfolio.netCogs)}</strong><small>Good returns reverse COGS</small></article></section>
